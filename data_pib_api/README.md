...
This folder defines all source code for the 'Ingesta_bronze' pipeline:
...
* Take a look at the sample under "sample_users_ingesta_bronze.py" to get familiar with the syntax.
